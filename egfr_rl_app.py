...
def boltzmann_action_selection(q_values, tau=7.0):
...
def recommend_treatment(patient_features, previous_treatment_value):
    ...
    if previous_treatment_value == 1:
        ...
        selected_action_idx = boltzmann_action_selection(q_values, tau=7)  # Index of valid action (0 or 1)
        ...
        recommended_action = boltzmann_action_selection(q_values, tau=7)
